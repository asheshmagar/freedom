		...
		<div class="freedom-upsell-wrapper">
			<ul class="upsell-features">
				...
				<li class="upsell-feature"><span
						class="dashicons dashicons-yes"></span><?php esc_html_e( 'Advanced Header Options', 'freedom' ); ?>
				</li>
				<li class="upsell-feature"><span
				...
				<li class="upsell-feature"><span
						class="dashicons dashicons-yes"></span><?php esc_html_e( 'Different Footer Designs', 'freedom' ); ?>
				</li>
				<li class="upsell-feature"><span
						class="dashicons dashicons-yes"></span><?php esc_html_e( '100+ Customizer Options', 'freedom' ); ?>
				</li>
				<li class="upsell-feature"><span
						class="dashicons dashicons-yes"></span><?php esc_html_e( 'Advanced Page Settings', 'freedom' ); ?>
				</li>
			</ul>
