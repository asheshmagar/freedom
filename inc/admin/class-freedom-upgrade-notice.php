...
class Freedom_Upgrade_Notice extends Freedom_Notice {
	...
	public function set_dismiss_notice() {
		 ...
		 *
		 * 1. Freedom Pro plugin is active.
	...
	public function notice_markup() {
		...
		<div class="notice notice-success freedom-notice">
			...
			<div class="links">
				...
				<a href="https://freedomtheme.com/support/?utm_source=freedom-dashboard-message&utm_medium=button-link&utm_campaign=pre-sales" class="button button-secondary" target="_blank">
